...
export const ICONS = {
  ...
  // 警備兵: 兜と槍を構えた門番の兵士
  guard: {
    palette: { "0": "#1a1a24", "1": "#9aa6b2", "2": "#b8c0d0", "3": "#e8c47a", "4": "#8a5a2b", "5": "#d8dde6" },
    art: [
      ".........5..",
      "....0....4..",
      "...0220..4..",
  ...
  // 帰還魔法陣: 床に刻まれた光の円環。踏むと街へ帰還できる
  portal: {
    palette: { "0": "#3a2a6a", "1": "#7fd0ff", "2": "#aef0ff", "3": "#ffffff" },
    art: [
      "............",
      "...001100...",
      "..01122110..",
  ...
  ember: {
    palette: { "0": "#3a1400", "1": "#d4361a", "2": "#ff7a2a", "3": "#ffc24a", "4": "#fff2b0" },
    art: [
      ".....0......",
      "....040.....",
      "....0430....",
