...
export const ARTS = {
  ...
  // 腐乱した亡者。前かがみの肉付きの体・剥き出しの肋・垂れた腕で、白骨のスケルトンと描き分ける
  zombie: {
    palette: { o: "#14200e", G: "#6e8a46", g: "#46582c", H: "#9ab46a", b: "#cabf9a", R: "#a83232", k: "#0a0a0a" },
    art: [
      ".....ooooo......",
      "....oGGGGGo.....",
      "...oGHHHGGGo....",
  ...
  // ハイエナ頭の戦士。とがった双耳・牙の覗く長い口吻・斑のたてがみで、オークと描き分ける
  gnoll: {
    palette: { o: "#20160a", S: "#b08a4a", s: "#6e4e24", k: "#0e0a06", W: "#f0ece2", Y: "#e8c24a" },
    art: [
      "....oo.oo......",
      "...okSoSko.....",
      "...oSSSSSo.....",
  ...
  // 肥えた節くれの大蛆。前端の大顎と丸い眼・尾に向かって細る節体で、蜘蛛と描き分ける
  maggot: {
    palette: { o: "#3a3030", M: "#d8c8b8", m: "#a89888", k: "#2a2020", R: "#a83838" },
    art: [
      "......oooo......",
      ".....oMMMMo.....",
      "..kooMMMMMMook..",
