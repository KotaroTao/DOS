...
export const monsters = defMonsters([
  ...
  { id: "d02_harpy", name: "城砦のハーピー", race: "avian", element: "wind", artKey: "harpy", rank: 2,
    ...
    desc: "崩れた尖塔を巣とする、女の貌と猛禽の体を持つ魔物。耳を聾する嬌声で獲物を竦ませ、突風とともに舞い降りて鉤爪で眼を抉る。巣には磨かれた指輪や髪飾りが集められ、持ち主はもうどこにもいない。" },
  { id: "d02_imp", name: "小悪魔", race: "demon", element: "fire", artKey: "imp", rank: 2,
    hp: 22, atk: 12, def: 4, spd: 11, exp: 19, gold: 13,
    desc: "城の崩落に引き寄せられ、地獄の裂け目から這い出た下級の悪魔。掌に灯した火種で書物や梁を焼き、人の絶望を肴に嗤う。契約を持ちかける口ぶりは巧みだが、署名した者の魂はその場で炙られる。" },
  { id: "d02_lizard", name: "城砦の蜥蜴", race: "reptile", element: "earth", artKey: "lizard", rank: 3,
  ...
  { id: "d02_lord", name: "城主の亡霊", race: "specter", element: "dark", artKey: "wraith", rank: 3, boss: true,
    ...
    desc: "民を見捨てて自らだけ生き延びようとし、その報いに城もろとも呪われた領主の末路。今や瘴気の塊となり、誰もいない玉座の間を彷徨い続ける。近づく者を旧臣と見做し、忠誠を試すように冷たい手を伸ばす。" },
]);
