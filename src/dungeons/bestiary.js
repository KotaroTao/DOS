...
const NEW_DEFS = [
  ...
  { id: "bs_drainrat", name: "溝鼠", rank: 1, race: "beast", element: "none", artKey: "kobold",
    ...
    desc: "下水と骸の悪臭に慣れきった大鼠。小賢しく群れをなし、眠った者の耳や指から順に齧り始める。" },
  { id: "bs_shroomspirit", name: "毒茸の魔", rank: 1, race: "plant", element: "earth", artKey: "mandrake",
    palette: tint(ARTS.mandrake.palette, "#9a3a7a", 0.4),
    desc: "地下墓地の湿気を糧に育った毒茸の化身。胞子を吸った者は幻を見ながら眠り続け、そのまま二度と目覚めない。" },
  ...
  { id: "bs_gnoll", name: "ゴール", rank: 2, race: "humanoid", element: "earth", artKey: "orc", soulClass: "fighter",
    ...
    desc: "ハイエナの顎を持つ異形の戦士。骨ごと噛み砕く咬合力を誇り、迷宮で死んだ者の装備を剥いで身につける。" },
  ...
  { id: "bs_hobgoblin", name: "ホブゴブリン", rank: 2, race: "humanoid", element: "none", artKey: "kobold", soulClass: "thief",
    ...
    desc: "ゴブリンの中でも知恵と体格に恵まれた上位種。仲間を囮に使い、退路を断いた上で奇襲するのを好む。" },
  ...
  { id: "bs_marshgolem", name: "泥のゴーレム", rank: 3, race: "construct", element: "earth", artKey: "golem",
    ...
    desc: "廃砦跡の湿地に積もった泥が、呪文の残滓を吸って動き出したゴーレム。動くたびに腐臭を撒き散らし、跡には沼の跡が残る。" },
  ...
  { id: "bs_cultist", name: "邪神の僧", rank: 4, race: "specter", element: "dark", artKey: "ghost", soulClass: "bishop",
    ...
    desc: "禁忌の神を祀り命を捧げた僧侶の亡霊。神に近づくために捨てたものを、今も取り戻そうとするように手を伸ばしてくる。" },
  ...
  { id: "bs_shadowmage", name: "影の術師", rank: 5, race: "undead", element: "dark", artKey: "ghost", soulClass: "mage",
    ...
    desc: "禁呪に魂を喰われた術師の残滓。肉体は消え失せ、影だけが術を唱え続ける。召喚した闇の眷属は術師と共に消えない。" },
  ...
  { id: "bs_bloodwraith", name: "血霊", rank: 6, race: "specter", element: "dark", artKey: "wraith",
    ...
    desc: "熔岩洞で大量の血が流された場所に生まれた血の亡霊。触れられた者の血が傷口から引き出され、霊体の一部になる。" },
  ...
  { id: "bs_steelspider", name: "鋼蜘蛛", rank: 6, race: "construct", element: "none", artKey: "spider",
    ...
    desc: "古代の錬金術師が造った鉄製の機械蜘蛛。熔岩に落ちても溶けずに動き続け、絹より細く鋼より強い糸で罠を張る。" },
  // -- rank 7 追加 (+5) --
  ...
  { id: "bs_plaguewraith", name: "疫病の亡霊", rank: 8, race: "undead", element: "dark", artKey: "ghost",
    ...
    desc: "大疫病で死んだ者たちが一つに溶け合った亡霊の群れ。その靄に触れた者はたちまち高熱に侵され、三日三晩うなされる。" },
  ...
  { id: "bs_dreadlich", name: "慟哭のリッチ", rank: 8, race: "undead", element: "dark", artKey: "skeleton", soulClass: "mage",
    palette: tint(ARTS.skeleton.palette, "#5a2a7a", 0.45),
    desc: "魂を複数の宝珠に分けて隠した古代の死霊術師の上位種。その慟哭は宝珠の在処を知らせる声であり、聴いた者は宝珠を探さずにいられない。" },
  ...
  { id: "bs_divinegolem", name: "神の傀儡", rank: 9, race: "construct", element: "light", artKey: "golem",
    palette: tint(ARTS.golem.palette, "#e0d0a0", 0.4),
    desc: "神が最後の審判のために造った審判の傀儡。罪なき者には手を出さないが、迷宮に踏み込んだ時点で全員を罪ある者と判定する。" },
  ...
  { id: "bs_infernaltyrant", name: "獄炎の暴君", rank: 9, race: "demon", element: "fire", artKey: "ogre",
    ...
    desc: "地獄の最深層を統べる炎の悪魔の将。踏みつけた大地が熔岩に変わり、拳で叩き潰した者の魂が炎の中に閉じ込められる。" },
  // -- rank 10 追加 (+7) --
