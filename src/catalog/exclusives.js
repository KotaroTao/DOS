...
const L = [
  excl(S("x_hero_shield", "勇者の神盾", 192, {
    cls: ["hero"], shape: "round", pow: 1.3, eDef: ["light", 1], hp: 250, luk: 20,
  ...
  excl(H("x_cardinal_crown", "枢機卿の宝冠", 186, {
    cls: ["cardinal"], shape: "circlet", pow: 1.15, eDef: ["light", 1], pie: 120, mp: 100, hp: 180,
